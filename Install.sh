...
pacstrap -P /mnt --needed libusb-compat usb_modeswitch smartmontools nvme-cli hdparm zsh grml-zsh-config thermald \
  ...
  neofetch htop galculator gparted ntfs-3g mediainfo-gui vlc obs-studio audacity fdkaac gimp steam firefox transmission-gtk flatpak $Packages \
...
echo '#WINE_HEAP_DELAY_FREE=1' >> /etc/environment
